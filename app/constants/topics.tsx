...
// 토픽 제목으로 토픽 찾기 헬퍼 함수
export const findTopicByTitle = (title: string): Topic | undefined => {
  return AVAILABLE_TOPICS.find(topic => topic.title === title);
};

// 선택된 토픽들의 아이콘 가져오기
export const getSelectedTopicIcons = (selectedTitles: string[]): Topic[] => {
  return selectedTitles
    .map(title => findTopicByTitle(title))
